...
def uninstallation_paths(dist: BaseDistribution) -> Iterator[str]:
    ...
    if entries is None:
<<<<<<< HEAD:backend/venv/Lib/site-packages/pip/_internal/req/req_uninstall.py
...
>>>>>>> 13c9fa6e327e114338645094a6c576efc33c6ffa:venv/Lib/site-packages/pip/_internal/req/req_uninstall.py
