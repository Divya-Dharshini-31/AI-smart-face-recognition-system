...
class TempDirectory:
    ...
    def cleanup(self) -> None:
        ...
        if not os.path.exists(self._path):
            return
<<<<<<< HEAD:backend/venv/Lib/site-packages/pip/_internal/utils/temp_dir.py
...
=======
        rmtree(self._path)
>>>>>>> 13c9fa6e327e114338645094a6c576efc33c6ffa:venv/Lib/site-packages/pip/_internal/utils/temp_dir.py
