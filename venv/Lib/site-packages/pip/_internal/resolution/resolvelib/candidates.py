...
class AlreadyInstalledCandidate(Candidate):
    ...
    @property
<<<<<<< HEAD:backend/venv/Lib/site-packages/pip/_internal/resolution/resolvelib/candidates.py
    def version(self) -> Version:
        if self._version is None:
            self._version = self.dist.version
        return self._version
...
>>>>>>> 13c9fa6e327e114338645094a6c576efc33c6ffa:venv/Lib/site-packages/pip/_internal/resolution/resolvelib/candidates.py
