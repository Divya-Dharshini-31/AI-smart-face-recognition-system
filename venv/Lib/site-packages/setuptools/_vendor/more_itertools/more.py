...
__all__ = [
    ...
    'circular_shifts',
    'collapse',
<<<<<<< HEAD:backend/venv/Lib/site-packages/pkg_resources/_vendor/more_itertools/more.py
    'combination_index',
=======
    'collate',
>>>>>>> 13c9fa6e327e114338645094a6c576efc33c6ffa:venv/Lib/site-packages/setuptools/_vendor/more_itertools/more.py
    'consecutive_groups',
    'constrained_batches',
    'consumer',
    'countable',
