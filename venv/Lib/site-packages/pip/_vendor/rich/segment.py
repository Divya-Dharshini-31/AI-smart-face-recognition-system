...
class Segment(NamedTuple):
    ...
    @classmethod
    @lru_cache(1024 * 16)
<<<<<<< HEAD:backend/venv/Lib/site-packages/pip/_vendor/rich/segment.py
    def _split_cells(cls, segment: "Segment", cut: int) -> Tuple["Segment", "Segment"]:
=======
    def _split_cells(cls, segment: "Segment", cut: int) -> Tuple["Segment", "Segment"]:  # type: ignore

>>>>>>> 13c9fa6e327e114338645094a6c576efc33c6ffa:venv/Lib/site-packages/pip/_vendor/rich/segment.py
