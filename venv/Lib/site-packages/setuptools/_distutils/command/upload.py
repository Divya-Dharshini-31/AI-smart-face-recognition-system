...
<<<<<<< HEAD:backend/venv/Lib/site-packages/setuptools/_distutils/command/upload.py
        msg = "Submitting {} to {}".format(filename, self.repository)
        self.announce(msg, logging.INFO)
=======
        msg = "Submitting %s to %s" % (filename, self.repository)
        self.announce(msg, log.INFO)
>>>>>>> 13c9fa6e327e114338645094a6c576efc33c6ffa:venv/Lib/site-packages/setuptools/_distutils/command/upload.py
