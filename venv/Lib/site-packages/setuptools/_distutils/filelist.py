...
<<<<<<< HEAD:backend/venv/Lib/site-packages/setuptools/_distutils/filelist.py
                    log.warning("warning: no files found matching '%s'", pattern)
=======
                    log.warn("warning: no files found matching '%s'",
                             pattern)
>>>>>>> 13c9fa6e327e114338645094a6c576efc33c6ffa:venv/Lib/site-packages/setuptools/_distutils/filelist.py
